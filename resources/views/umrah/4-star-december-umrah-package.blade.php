    ...
    <div class="pkg-header-top text-center">
        <div class="container">
            ...
            <div class="hotel-summary">
                ...
                <span class="ml-3">Elaf Meshal Al Madina (5 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">PKR 280,000</span> per person
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Experience a spiritually enriching 10-night Umrah journey this December with Umrah Agency Pakistan. Stay at the renowned Elaf Ajyad in Makkah and Elaf Meshal Al Madina in Madinah, both known for their comfort and hospitality. This perfectly balanced package allows you to focus on your worship and reflection during the cooler winter months.</p>
                    </div>
                    ...
                    <div class="section-card">
                        ...
                        <div class="hotel-item p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">ELAF MESHAL AL MADINA</h5>
    ...
    <section id="footer-slider">
        <div class="container">
            <div class="footer-slick-carousel">
                <div><img src="{{asset('assets/media/umrah/01-min%20%2841%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/02-min%20%2838%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/03-min%20%2838%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/04-min%20%2836%29.webp')}}" alt=""></div>
            </div>
        </div>
    </section>
@endsection
