...
@section('content')
    ...
    <div class="pkg-header-top text-center">
        <div class="container">
            <h1>10 Nights 5 Star March Umrah package</h1>
            <div class="hotel-summary">
                <span>Makkah Clock Royal Tower (5 nights)</span>
                ...
                <span class="ml-3">Pullman ZamZam (5 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">PKR 380,000</span> per person
                </div>
                <div class="deposit-btn">
                    <i class="fa fa-bookmark"></i> Book with just PKR 15,000 deposit
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Experience a blessed Umrah journey with Umrah Agency Pakistan. This 10-night luxury package is designed for maximum comfort and spiritual focus. Enjoy the convenience of premium accommodation near the Holy Mosques in both Makkah and Madinah, with all essentials handled by our professional team.</p>
                    </div>
                    ...
                    <div class="section-card">
                        ...
                        <div class="hotel-item mb-4 p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">MAKKAH CLOCK ROYAL TOWER</h5>
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> 5 Star Hotel in Makkah (5 Nights)</p>
                                </div>
                        ...
                        <div class="hotel-item p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">PULLMAN ZAMZAM</h5>
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> 5 Star Hotel in Madinah (5 Nights)</p>
                                </div>
                                <div class="col-md-4 text-md-right mt-3 mt-md-0">
                                    <div class="stars mb-2">
                                        <i class="fa fa-star text-warning"></i>
    ...
    <section id="footer-slider">
        <div class="container">
            <div class="footer-slick-carousel">
                <div><img src="{{asset('assets/media/umrah/001.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/02%20%288%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/03%20%288%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/04%20%288%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/05%20%284%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/06.webp')}}" alt=""></div>
            </div>
        </div>
    </section>
@endsection
