    ...
    <div class="pkg-header-top text-center">
        <div class="container">
            ...
            <div class="hotel-summary">
                <span>Shohada Hotel Makkah (4 nights)</span>
                ...
                <span class="ml-3">New Madinah Hotel (3 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">PKR 330,000</span> per person
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Experience a spiritually fulfilling Umrah journey this October with our 5-star economy package. Stay at the Shohada Hotel in Makkah and the New Madinah Hotel in Madinah, both offering superior comfort and proximity to the Holy Mosques. This 7-night package is tailored to provide a premium experience at an excellent value.</p>
                    </div>
                    ...
                    <div class="section-card">
                        ...
                        <div class="hotel-item mb-4 p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">SHOHADA HOTEL MAKKAH</h5>
                        ...
                        <div class="hotel-item p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">NEW MADINAH HOTEL</h5>
    ...
    <section id="footer-slider">
        <div class="container">
            <div class="footer-slick-carousel">
                <div><img src="{{asset('assets/media/umrah/03%20%2839%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/02%20%2839%29.webp')}}" alt=""></div>
            </div>
        </div>
    </section>
@endsection
