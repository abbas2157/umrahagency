...
@section('meta')
    <title>4 Star 14 Nights December Umrah Package | Elaf Ajyad & Elaf Taibah</title>
    <meta name="description" content="Book our 4 Star 14 Nights December Umrah Package staying at Elaf Ajyad Makkah and Elaf Taibah Madinah. All-inclusive deals from major cities in Pakistan.">
    <link rel="canonical" href="https://umrahagency.pk/umrah/4-star-night-december-umrah-package.html" />
    @section('og_title', '4 Star 14 Nights December Umrah Package | Elaf Ajyad & Elaf Taibah')
    @section('og_description', 'Book our 4 Star 14 Nights December Umrah Package staying at Elaf Ajyad Makkah and Elaf Taibah Madinah. All-inclusive deals from major cities in Pakistan.')
    @section('og_url', 'https://umrahagency.pk/umrah/4-star-night-december-umrah-package.html')
@endsection
@section('content')
    ...
    <div class="pkg-header-top text-center">
        <div class="container">
            ...
            <div class="hotel-summary">
                ...
                <span class="ml-3">Elaf Taibah (7 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    ...
                    <div class="section-card">
                        ...
                        <div class="hotel-item mb-4 p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">ELAF AJYAD</h5>
                        ...
                        <div class="hotel-item p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">ELAF TAIBAH</h5>
    ...
    <section id="footer-slider">
        <div class="container">
            <div class="footer-slick-carousel">
                <div><img src="{{asset('assets/media/umrah/1%20%286%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/2%20%286%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/3%20%286%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/4%20%286%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/5%20%285%29.webp')}}" alt=""></div>
            </div>
        </div>
    </section>
@endsection
