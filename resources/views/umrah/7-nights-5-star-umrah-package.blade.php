...
@section('content')
    ...
    <div class="pkg-header-top text-center">
        <div class="container">
            <h1>7 Nights 5 Star March Umrah Package</h1>
            <div class="hotel-summary">
                <span>Swissotel Makkah (4 nights)</span>
                ...
                <span class="ml-3">Anwar Al Madinah Movenpick (3 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">PKR 350,000</span> per person
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Embark on a spiritually enriching 7-night Umrah journey this March. Enjoy the premium luxury and exceptional service of Swissotel Makkah and Anwar Al Madinah Movenpick. This package is curated to provide you with the most comfortable and memorable spiritual experience during the beautiful month of March.</p>
                    </div>
                    ...
                    <div class="section-card">
                        ...
                        <div class="hotel-item mb-4 p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">SWISSOTEL MAKKAH</h5>
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> Superior 5 Star Hotel in Makkah (4 Nights)</p>
                                </div>
                        ...
                        <div class="hotel-item p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> Superior 5 Star Hotel in Madinah (3 Nights)</p>
                                </div>
                                <div class="col-md-4 text-md-right mt-3 mt-md-0">
                                    <div class="stars mb-2">
                                        <i class="fa fa-star text-warning"></i>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled included-list">
                                    ...
                                    <li class="d-flex align-items-center"><i class="fa fa-check-circle text-success mr-2"></i> Makkah 5* Hotel (4 Nights)</li>
                                    <li class="d-flex align-items-center"><i class="fa fa-check-circle text-success mr-2"></i> Madinah 5* Hotel (3 Nights)</li>

                                    <li class="d-flex align-items-center"><i class="fa fa-check-circle text-success mr-2"></i> Breakfast Included</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
    ...
    <section id="footer-slider">
        <div class="container">
            <div class="footer-slick-carousel">
                <div><img src="{{asset('assets/media/umrah/01%20%285%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/02%20%285%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/03%20%285%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/04%20%285%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/05%20%282%29.webp')}}" alt=""></div>
            </div>
        </div>
    </section>
@endsection
