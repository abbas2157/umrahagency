...
@section('content')
    ...
    <div class="pkg-header-top text-center">
        <div class="container">
            <h1>7 Nights 3 Star Umrah Package</h1>
            <div class="hotel-summary">
                <span>Al Kiswah Tower (4 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                </span>
                <span class="ml-3">Emaar Taibah (3 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">PKR 210,000</span> per person
                </div>
    ...
    <!--package detail section End-->
                    ...
                    <div class="section-card">
                        ...
                        <div class="hotel-item mb-4 p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> 3 Star Hotel in Makkah</p>
                                </div>
                        ...
                        <div class="hotel-item p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">EMAAR TAIBAH</h5>
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> 3 Star Hotel in Madinah</p>
                                </div>
                                <div class="col-md-4 text-md-right mt-3 mt-md-0">
                                    <div class="stars mb-2">
                                        <i class="fa fa-star text-warning"></i>
    ...
    <section id="footer-slider">
        <div class="container">
            <div class="footer-slick-carousel">
                <div><img src="{{asset('assets/media/umrah/2%20%288%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/3%20%288%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/4%20%288%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/5%20%287%29.webp')}}" alt=""></div>
            </div>
        </div>
    </section>
