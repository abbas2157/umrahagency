...
@section('content')
    ...
    <div class="pkg-header-top text-center">
        <div class="container">
            <h1>4 Star 10 Nights December Umrah Package</h1>
            <div class="hotel-summary">
                <span>VOCO MAKKAH (5 nights)</span>
                ...
                <span class="ml-3">Saja Al Medina Hotel (5 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">PKR 255,000</span> per person
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Perform Umrah during the serene month of December with our specialized 10-night 4-star package. Stay at the elegant VOCO Makkah and Saja Al Medina, enjoying high-quality service and proximity to the Holy Haram. This package is designed to provide a comfortable and spiritually uplifting experience during the cooler winter months.</p>
                    </div>
                        ...
                        <div class="hotel-item mb-4 p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> 4 Star Hotel in Makkah (5 Nights)</p>
                                </div>
                        ...
                        <div class="hotel-item p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> 4 Star Hotel in Madinah (5 Nights)</p>
                                </div>
                                <div class="col-md-4 text-md-right mt-3 mt-md-0">
                                    <div class="stars mb-2">
                                        <i class="fa fa-star text-warning"></i>
    ...
    <section id="footer-slider">
        <div class="container">
            <div class="footer-slick-carousel">
                <div><img src="{{asset('assets/media/umrah/1%20%284%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/2%20%284%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/3%20%284%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/4%20%284%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/5%20%284%29.webp')}}" alt=""></div>
            </div>
        </div>
    </section>
@endsection
