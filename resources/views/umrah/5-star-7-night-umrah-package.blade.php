...
@section('content')
    ...
    <div class="pkg-header-top text-center">
        <div class="container">
            <h1>5 Star 7 Nights Economy Umrah Package</h1>
            <div class="hotel-summary">
                <span>Infinity Hotel (4 nights)</span>
                ...
                <span class="ml-3">Crowne Plaza Madinah (3 nights)</span>
                <span class="stars mx-2">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Perform your Umrah with comfort and affordability. Our 5-star economy package offers excellent value, featuring stays at the Infinity Hotel in Makkah and Crowne Plaza in Madinah. This 7-night journey is designed for those seeking premium 5-star accommodation at a competitive price point.</p>
                    </div>
                    ...
                    <div class="section-card">
                        ...
                        <div class="hotel-item mb-4 p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">INFINITY HOTEL</h5>
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> 5 Star Hotel in Makkah (4 Nights)</p>
                                </div>
                        ...
                        <div class="hotel-item p-4 bg-light-cream rounded border">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h5 class="mb-1 font-weight-bold">CROWNE PLAZA MADINAH</h5>
                                    <p class="small text-muted mb-0"><i class="fa fa-map-marker text-danger mr-1"></i> 5 Star Hotel in Madinah (3 Nights)</p>
                                </div>
                                <div class="col-md-4 text-md-right mt-3 mt-md-0">
                                    <div class="stars mb-2">
                                        <i class="fa fa-star text-warning"></i>
    ...
    <section id="footer-slider">
        <div class="container">
            <div class="footer-slick-carousel">
                <div><img src="{{asset('assets/media/umrah/01%20%2834%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/02%20%2835%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/03%20%2835%29.webp')}}" alt=""></div>
                <div><img src="{{asset('assets/media/umrah/04%20%2835%29.webp')}}" alt=""></div>
            </div>
        </div>
    </section>
@endsection
